...
local RF-DETR checkpoint path. If the RF-DETR checkpoint is absent, it is
downloaded from [phucn001/crane_safety_zone_model](https://huggingface.co/phucn001/crane_safety_zone_model).
The official YOLO26m-seg weight is downloaded
